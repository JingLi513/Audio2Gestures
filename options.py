...
def options():
    ...
    parser.add_argument("--input_joint_num", type=int, default=22)
    parser.add_argument("--output_joint_num", type=int, default=22)
    parser.add_argument("--input_joint_repr_dim", type=int, default=6)
    parser.add_argument("--output_joint_repr_dim", type=int, default=6)
    ...
    parser.add_argument("--audio_stat", type=str, default="./speech_stat.npy")
